...
export function Playground() {
  ...
  const [img2ImgStrength, setImg2ImgStrength] = useState(0.9)
  const [img2ImgNegativePrompt, setImg2ImgNegativePrompt] = useState('')
  const [img2ImgGuidanceScale, setImg2ImgGuidanceScale] = useState(0.5)
  const [img2ImgControlnetScale, setImg2ImgControlnetScale] = useState(0.5)
  const [img2ImgSteps, setImg2ImgSteps] = useState(8)
