...
5.auto prompt的优先级是怎么样的，是会覆盖还是合并，搜索官方文档调研

6.局部重绘需要支持画笔手绘微调，然后可以重置微调

7.结合官方文档，调研是否可以用ltx-2.3-22b-distilled-lora-384.safetensors替换ltx-2-19b-distilled-lora-384.safetensors，5090 32g的显卡0会参数不兼容或者爆显存吗，效果会更好吗，还是不支持替换